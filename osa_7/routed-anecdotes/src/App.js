...
const Menu = ({anecdotes, setAnecdotes, anecdoteById, setNotification}) => {
	const padding = {
		paddingRight: 5
	}
...
const CreateNew = withRouter(Submit)
...
const App = () => {
	...
	return (
		<div>
			...
			<p>{notification}</p>
			<Menu anecdotes={anecdotes} setAnecdotes={setAnecdotes} anecdoteById={anecdoteById} setNotification={setNotification}/>
			<Footer />
		</div>
	)
}
